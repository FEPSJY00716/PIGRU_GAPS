...
for epoch in range(num_epochs):
    ...
    if mean_val_loss < best_val_loss:
        ...
        # torch.save(model.state_dict(), 'bestmodel/matlab_split6&4/trainset_TZ1230-0105/gru_10min_history_forward_model_best_v3_TZ.pth')
...
losses_df.to_csv('results/matlab_split6&4/trainset_CQ07/gru_training_losses.csv', index=False)
